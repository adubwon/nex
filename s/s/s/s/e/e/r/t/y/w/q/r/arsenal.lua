...
local Window     = Library.CreateLib("Warp Hub [.gg/warphub]", "BlueTheme")

local Welcome     = Window:NewTab("Main")
local MainSection = Welcome:NewSection("Welcome To Warp Hub [.gg/warphub] | " .. game.Players.LocalPlayer.Name)
...
local function enableParticles()
  ...
  local function names()
      ...
      gui.GUI_Scorecard.Scorecard.PlayerCard.Username.Text = "Warp Hub"
  end
...
local Section = Credit:NewSection("Script Developed by: Warp Hub")
Section:NewDropdown("Developer", "Dev", {"adub"}, function(currentDeveloper)
    local creations = {
        adub = "Owner"
    }
...
Section:NewButton("Copy Discord Link", "Discord", function()
    setclipboard("https://discord.com/invite/warphub")
end)
